...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    public void announimyslySingIn(View view){
        mAuth.signInAnonymously().addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (!task.isSuccessful()){
                    Log.d(MainActivity.TAG, "Exeption : " + task.getException());
                }else {
    ...
    private void initWidgets() {
        ...
        singInBtn = (Button) findViewById(R.id.imageBtn);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.d(MainActivity.TAG, "ConnectionResult Failed:" + connectionResult.toString());
    }

    private void firebaseAuthWithGoogle(GoogleSignInAccount account) {
        Log.d(MainActivity.TAG, "firebaseAuthWithGoogle:" + account.getId());
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        Log.d(TAG, "signInWithCredential: oncomplite: " + task.isSuccessful());
                    }
                });
    }
